          ...
          <div id="profile-page" class="section">
            ...
            <div id="profile-page-header" class="card">
                <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator" src="{!! asset('links/images/user-profile-bg.jpg') !!}" alt="user background">                    
                </div>
                <figure class="card-profile-image">
                    <img src="{!! asset('links/images/avatar.jpg') !!}" alt="profile image" class="circle z-depth-2 responsive-img activator">
                </figure>
                ...
                <div class="card-reveal">
                    <p>
                      <span class="card-title grey-text text-darken-4">Roger Waters <i class="mdi-navigation-close left"></i></span>
                    ...
                    <p><i class="mdi-device-airplanemode-on cyan-text text-darken-2"></i> Male</p>
                </div>
            </div>
            <!--/ profile-page-header -->
              ...
              <div id="profile-page-sidebar" class="col s12 m4">
                ...
                <ul id="profile-page-about-details" class="collection z-depth-1">
                  <li class="collection-item">
                    <div class="row">
                      ...
                      <div class="col s7 grey-text text-darken-4 left-align">ABC Name</div>
                    </div>
                  </li>
                  <li class="collection-item">
                    <div class="row">
                      <div class="col s5 grey-text darken-1"><i class="mdi-social-poll"></i> Skills</div>
                      <div class="col s7 grey-text text-darken-4 left-align">HTML, CSS</div>
                    </div>
                  </li>
                  <li class="collection-item">
                    <div class="row">
                      <div class="col s5 grey-text darken-1"><i class="mdi-social-domain"></i> Lives in</div>
                      <div class="col s7 grey-text text-darken-4 left-align">NY, USA</div>
                    </div>
                  </li>
                  <li class="collection-item">
                    <div class="row">
                      <div class="col s5 grey-text darken-1"><i class="mdi-social-cake"></i> Birth date</div>
                      <div class="col s7 grey-text text-darken-4 left-align">18th June, 1991</div>
                    </div>
                  </li>
                </ul>
                <!--/ Profile About Details  -->
                ...
                <ul id="profile-page-about-feed" class="collection z-depth-1">
                  <li class="collection-item avatar">
                    <img src="{!! asset('links/images/avatar.jpg') !!}" alt="" class="circle">
                ...
                <div class="map-card">
                    <div class="card">
                        ...
                        <div class="card-content">                    
                            <a class="btn-floating activator btn-move-up waves-effect waves-light darken-2 left">
                        ...
                        <div class="card-reveal">
                            <span class="card-title grey-text text-darken-4">Company Name LLC <i class="mdi-navigation-close left"></i></span>                   
                ...
                <div id="profile-page-wall-share" class="row">
                  <div class="col s12">
                    ...
                    <div id="UpdateStatus" class="tab-content col s12  grey lighten-4">
                      <div class="row">
                        <div class="col s2">
                          <img src="{!! asset('links/images/avatar.jpg') !!}" alt="" class="circle responsive-img valign profile-image-post">
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col s12 m6 left-align">
                           <!-- Dropdown Trigger -->
                            ...
                            <a class="waves-effect waves-light btn"><i class="mdi-maps-rate-review right"></i>Post</a>
                        </div>
                      </div>
                    </div>
                    <!-- AddPhotos -->
                  ...
                  <div class="col s12">
                      ...
                      <div id="profile-page-wall-post" class="card">
                        <div class="card-profile-title">
                          <div class="row">
                            <div class="col s1">
                              <img src="{!! asset('links/images/avatar.jpg') !!}" alt="" class="circle responsive-img valign profile-post-uer-image">                        
                            </div>
                            <div class="col s10">
                        ...
                        <div class="card-image profile-medium">                          
                          <img src="{!! asset('links/images/gallary/2.jpg') !!}" alt="sample" class="responsive-img profile-post-image profile-medium">                        
                      ...
                      <div id="profile-page-wall-post" class="card">
                        ...
                        <div class="card-image profile-small">
                          <img src="{!! asset('links/images/gallary/1.jpg') !!}" alt="sample" class="responsive-img profile-post-image">                        
                          <span class="card-title">Card Title</span>
                        </div>
                        <div class="card-content">
                          <p>I am a very simple card. I am good at containing small bits of information. I am convenient because I require little markup to use effectively.</p>
                      ...
                      <div id="profile-page-wall-post" class="card">
                        ...
                        <div class="card-image profile-large">
                          <img src="{!! asset('links/images/gallary/3.jpg') !!}" alt="sample" class="responsive-img profile-post-image">                        
                          <span class="card-title">Card Title</span>
                        </div>
                        <div class="card-content">
                          <p>I am a very simple card. I am good at containing small bits of information. I am convenient because I require little markup to use effectively.</p>
