...
@section('content')
      ...
      <section id="content">
        ...
        <div class="container">
          ...
          <form id="regForm">
            ...
            <div class="tab"><h3>پنځمه برخه:د کورس څپرکی</h3>
              <div id="field">
              <div id="field0">
                <div class="row">
                    <form class="col s12">
              ...
              <div class="form-group">
                <div class="col-md-4">
                <button id="add-more" name="add-more" class="btn btn-primary">څپرکی زیاتول</button>
                </div>
                </div>
 ...
 @section('js')
 var newIn = ' <div id="field'+ next +'" name="field'+ next +'"><div class="row"><form class="col s12"><div class="row">  <div class="input-field col s6"> <input id="title" type="text"><label for="title">نوم</label> </div> <div><input id="es_time" type="time" > <label for="es_time">es_time</label></div> </div> <div class="row"><div class="input-field col s12"><textarea id="messagem" class="materialize-textarea" length="300"></textarea><label for="messagem">معلومات</label> </div></div></form></div>';
 @endsection()